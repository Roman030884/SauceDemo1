...
public class OverviewTest extends BaseTest {
    ...
    public void shouldBeGetSumItemTotal() throws InterruptedException {
        Thread.sleep(1000);
    ...
    @Test(retryAnalyzer = Retry.class)
    public void shouldBeGetTotal() throws InterruptedException {
        Thread.sleep(1000);
...
//    @Test(retryAnalyzer = Retry.class)
//    public void shouldBeGoToTheFinishPage() throws InterruptedException {
//        Thread.sleep(1000);
...
//
//    @Test(retryAnalyzer = Retry.class)
//    public void shouldBeGoToTheProductPage() {
